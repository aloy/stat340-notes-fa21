...
```{r}
# Approximate CI
quantile(p_draws, probs = c(0.035, 0.965))

# Exact CI (not asked for)
qbeta(c(0.035, 0.965), 151, 852)
```
...
```{r}
y_draws <- rbinom(1000, size = 100, prob = p_draws)
```
