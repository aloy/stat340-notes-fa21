...
.panel[.panel-name[Interval null]
```{r}
# Null probability
pnorm(0, mean = 1.96, sd = 0.7997)

# Alternative probability
1 - pnorm(0, mean = 1.96, sd = 0.7997)
```
]
]
...
How do we test $H_0: \mu = 0$ vs. $H_1: \mu \ne 0$?

.panelset[
.panel[.panel-name[Question]

]
.panel[.panel-name[Point null]
```{r}
# Calculate a credible interval
qnorm(c(0.05, 0.95), mean = 1.96, sd = 0.7997)
```
]
]
